...
enum Strings {
    ...
    static let numberOfComments: String = "120"
...
enum DataForStoriesView {
    // MARK: - Name
    static let name1: String = "iJustine"
    static let name2: String = "Emily"
    static let name3: String = "Juliana"
    static let name4: String = "Emma"
    static let name5: String = "Catherine"
}
